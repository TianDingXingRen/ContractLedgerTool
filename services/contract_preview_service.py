...
def editor_preview_model(source_docx: str, fields: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    try:
        source_path = helpers.safe_uploaded_docx_path(source_docx)
    except Exception:
    ...
    return build_preview_model(source_path, fields)
