...
(function contractDetailEditor() {
  ...
  function addPlanRow() {
    ...
    row.innerHTML = `
      <td><input type="hidden" name="plan_${index}_id" value=""><input type="hidden" name="plan_${index}_delete" value="0"><input name="plan_${index}_phase_name" value="" class="input input-bordered input-xs w-full"><input type="hidden" name="plan_${index}_confidence" value="low"><input type="hidden" name="plan_${index}_expected_trigger_date" value=""><span class="confidence-badge badge badge-ghost badge-xs mt-1">低</span></td>
