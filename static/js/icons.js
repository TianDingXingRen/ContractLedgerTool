...
(function() {
  ...
  var I = {
    ...
    "boxes":'<path d="m12 2 4.5 2.5L12 7 7.5 4.5 12 2z"/><path d="m5 8 4.5 2.5L5 13 1 10.5 5 8z"/><path d="m19 8 4 2.5-4 2.5-4.5-2.5L19 8z"/><path d="M7.5 4.5V9M16.5 4.5V9M5 13v5l4.5 2.5v-5L5 13zM19 13v5l-4.5 2.5v-5L19 13z"/>',
    ...
    "pencil-line":'<path d="m15 5 4 4L8 20H4v-4L15 5z"/><path d="m13 7 4 4"/><line x1="12" y1="20" x2="21" y2="20"/>',
    "paperclip":'<path d="m20 11-8.5 8.5a5 5 0 0 1-7-7L14 3a3.5 3.5 0 0 1 5 5l-9.5 9.5a2 2 0 0 1-3-3L15 6"/>',
    "plus":'<line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/>',
    "receipt-text":'<path d="M5 3v18l3-2 4 2 4-2 3 2V3l-3 2-4-2-4 2-3-2z"/><line x1="8" y1="9" x2="16" y2="9"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="13" y2="17"/>',
    "rows-3":'<rect x="3" y="4" width="18" height="4" rx="1"/><rect x="3" y="10" width="18" height="4" rx="1"/><rect x="3" y="16" width="18" height="4" rx="1"/>',
    "list-checks":'<path d="m3 6 2 2 3-4"/><path d="m3 14 2 2 3-4"/><line x1="11" y1="6" x2="21" y2="6"/><line x1="11" y1="14" x2="21" y2="14"/><line x1="11" y1="20" x2="21" y2="20"/>',
    "scan-text":'<path d="M4 7V5a1 1 0 0 1 1-1h2M17 4h2a1 1 0 0 1 1 1v2M20 17v2a1 1 0 0 1-1 1h-2M7 20H5a1 1 0 0 1-1-1v-2"/><line x1="7" y1="9" x2="17" y2="9"/><line x1="7" y1="13" x2="17" y2="13"/><line x1="7" y1="17" x2="13" y2="17"/>',
    "send":'<path d="m3 3 18 9-18 9 4-9-4-9z"/><line x1="7" y1="12" x2="21" y2="12"/>',
    "split":'<circle cx="6" cy="5" r="2"/><circle cx="18" cy="5" r="2"/><circle cx="12" cy="19" r="2"/><path d="M6 7v3c0 2 2 3 4 3h2M18 7v3c0 2-2 3-4 3h-2M12 13v4"/>',
  ...
  function render(el) {
    ...
    if (!Object.prototype.hasOwnProperty.call(I, name)) return;
    if (el.querySelector('svg')) return;
    el.innerHTML = W + I[name] + '</svg>';
    var svg = el.querySelector('svg');
    if (svg) Array.from(el.classList).forEach(function(c) { svg.classList.add(c); });
  }

  function renderAll() {
    document.querySelectorAll('[data-lucide]').forEach(render);
  }
    ...
    new MutationObserver(function(mutations) {
      mutations.forEach(function(m) {
        m.addedNodes.forEach(function(node) {
          if (node.nodeType === 1) {
            if (node.hasAttribute && node.hasAttribute('data-lucide')) render(node);
            if (node.querySelectorAll) node.querySelectorAll('[data-lucide]').forEach(render);
          }
        });
      });
